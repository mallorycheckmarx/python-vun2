...
error_list = dict((
        ...
        ('ALREADY_PERMBANNED', _('that user is already permanently banned')),
        ('ALREADY_PERMWIKIBANNED', _('that user is already permanently wikibanned')),
        ('ALREADY_INVITED', _('that user is already invited to be a moderator')),
        ('ALREADY_CONTRIBUTOR', _('that user is already an approved submitter')),
        ('ALREADY_BLOCKED', _('that user is already blocked')),
        ('ALREADY_WIKICONTRIBUTOR', _('that user is already a wikicontributor')),
        ('ALREADY_MUTED', _('that user is already muted')),
        ('ALREADY_FRIENDS', _('that user is already your friend')),
        ...
        ('PERMBANNED_FROM_SUBREDDIT', _('that user is already permanently banned from the subreddit')),
        ('PERMWIKIBANNED_FROM_SUBREDDIT', _('that user is already permanently wikibanned from the subreddit')),
        ('WIKIBANNED_FROM_SUBREDDIT', _('that user is banned from the subreddit')),
        ('MUTED_FROM_SUBREDDIT', _('that user is muted from the subreddit')),
        ('MODERATOR_INVITE_ON_SUBREDDIT', _('that user is invited to be a moderator')),
        ('CONTRIBUTOR_ON_SUBREDDIT', _('that user is an approved submitter')),
        ('WIKICONTRIBUTOR_ON_SUBREDDIT', _('that user is a wiki contributor')),
        ('FRIEND_OF_USER', _('that user is one of your friends')),
        ('ENEMY_OF_USER', _('that user is blocked by you')),
